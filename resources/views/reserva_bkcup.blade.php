                        ...
                        <form action="{{ route('reservation.store') }}" method="POST" id="reservation_form" class="max-w-4xl mx-auto mt-16 bg-gradient-to-br from-white to-blue-50 rounded-3xl shadow-2xl p-8 lg:p-12 border border-blue-100">
                            ...
                            <div class="space-y-8">
                                    ...
                                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                                        ...
                                        <div class="sm:col-span-2">
                                            ...
                                            <div class="flex items-center gap-4">
                                                <input type="number" id="personas" min="{{ config('reservations.min_people_per_reservation') }}" value="{{ config('reservations.min_people_per_reservation') }}" name="personas" class="block w-full rounded-xl border-2 border-gray-200 px-4 py-3 shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 text-base" required />
                                ...
                                <div id="availability-panel" class="hidden">
                                    <div class="bg-gradient-to-br from-blue-50 to-blue-100 border-2 border-blue-300 rounded-2xl p-6 shadow-lg">
                                        <div class="flex items-center gap-3 mb-4">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-6 h-6 text-blue-700">
                                                <path fill-rule="evenodd" d="M18 10a8 8 0 1 1-16 0 8 8 0 0 1 16 0Zm-7-4a1 1 0 1 1-2 0 1 1 0 0 1 2 0ZM9 9a.75.75 0 0 0 0 1.5h.253a.25.25 0 0 1 .244.304l-.459 2.066A1.75 1.75 0 0 0 10.747 15H11a.75.75 0 0 0 0-1.5h-.253a.25.25 0 0 1-.244-.304l.459-2.066A1.75 1.75 0 0 0 9.253 9H9Z" clip-rule="evenodd" />
                                            </svg>
                                            <h3 class="text-lg font-bold text-blue-900">Detalles de Disponibilidad</h3>
                                        </div>
                            ...
                            <div class="bg-white px-6 py-6">
                                ...
                                <div class="mt-6 bg-blue-50 rounded-xl p-4 border-2 border-blue-200">
                                    <p class="text-sm text-blue-900 leading-relaxed">
                                        <span class="font-bold">Nota:</span> Este mapa muestra la distribución de las áreas disponibles en Charros Sport Bar. Selecciona tu área preferida en el formulario de reserva.
                                    </p>
                                </div>
                            </div>
