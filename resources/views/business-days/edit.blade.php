                ...
                <form method="POST" action="{{ route('business-days.update', $businessDay->id) }}">
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="description" id="description" rows="3"
                                  class="shadow-sm border-gray-300 rounded-md w-full py-2 px-3 text-gray-900 focus:ring-indigo-500 focus:border-indigo-500">{{ old('description', $businessDay->description) }}</textarea>
                        @error('description')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
