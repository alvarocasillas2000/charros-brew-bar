        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-lg sm:rounded-xl">
                ...
                <div class="p-6">
                    ...
                    @auth
                    <!-- Reservation notes - MOVED TO TOP -->
                    <div class="mb-8">
                        @if(session('success'))
                        ...
                        <!-- Quick add note form -->
                        <form action="{{ route('reservations.notes.store', $reservation->id) }}" method="POST" class="mb-6">
                            @csrf
                            <div class="bg-gray-50 rounded-lg p-4 border border-gray-200">
                                <textarea 
                                    name="note" 
                        ...
                        @if($reservation->notes->isEmpty())
                            <p class="text-gray-600 italic text-sm">No hay notas previas para esta reservación.</p>
                        @else
                            <div class="space-y-4">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                ...
                                <div>
                                    ...
                                    <p class="text-3xl font-bold text-gray-700">
                                        ${{ number_format(config('reservations.base_ticket_cost'), 2) }}
                                    </p>
