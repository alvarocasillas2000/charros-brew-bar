    ...
    <div class="py-8">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-lg sm:rounded-xl">
                <div class="bg-gradient-to-r from-blue-700 to-blue-800 px-6 py-6 text-white">
                    ...
                    <p class="text-blue-100 text-sm mt-2">{{ $reservation->name }} - {{ $reservation->businessDay->date->format('d/m/Y') }}</p>
                </div>
                    ...
                    <form action="{{ route('reservations.notes.store', $reservation->id) }}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <textarea 
                                ...
                                name="note" 
                                rows="6"
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors @error('note') border-red-500 @enderror"
