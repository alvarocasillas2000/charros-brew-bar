<x-app-layout>
  @php
    $seoTitle = 'Charros Sport Bar | Vista Privilegiada al Estadio';
    ...
    <div
      ...
      <main id="page-content" class="flex max-w-full flex-auto flex-col">
          ...
          <div
            ...
            <div class="flex justify-center h-56 sm:h-64 md:h-80 animate-fade-in">
              <img
                ...
                alt="Charros Sport Bar Logo - Sport Bar en Estadio Charros de Jalisco Guadalajara"
            ...
            <div class="text-center space-y-6">
              <h2
                ...
                <span class="text-blue-300">Una nueva experiencia</span> en el béisbol
              </h2>
              <h3
                class="mx-auto text-xl font-medium text-blue-100 md:text-2xl md:leading-relaxed lg:w-3/4 animate-slide-up-delay">
            ...
            <div class="flex flex-wrap justify-center gap-6 pt-12 pb-20">
              <a href="{{ route('reservation.show') }}" class="group">
                <button
                  type="button"
                  class="inline-flex items-center justify-center gap-3 rounded-full border-2 text-xl border-blue-700 bg-blue-900 px-12 py-6 leading-6 font-bold text-white hover:border-blue-500 hover:bg-blue-500 hover:scale-105 focus:ring-4 focus:ring-blue-400/50 focus:outline-hidden active:border-blue-700 active:bg-blue-700 transition-all duration-300 shadow-2xl">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-calendar-check group-hover:scale-110 transition-transform"><path d="M8 2v4"/><path d="M16 2v4"/><rect width="18" height="18" x="3" y="4" rx="2"/><path d="M3 10h18"/><path d="m9 16 2 2 4-4"/></svg>
                  <span class="">¡Reserva Ya!</span>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-right group-hover:translate-x-1 transition-transform"><path d="m9 18 6-6-6-6"/></svg>
                </button>
              </a>
            </div>
            ...
            <div class="relative mx-5 -mb-24 rounded-2xl bg-white p-3 shadow-2xl sm:-mb-48 lg:mx-32 overflow-hidden border-4 border-white/20">
              <div
                ...
                style="min-width: 0;">
                @foreach([
                ['balls.webp', 'Muro de pelotas de béisbol en Charros Sport Bar'],
                ['beer.webp', 'Cerveza fría servida en Charros Sport Bar'],
                ...
                ['people.webp', 'Fans disfrutando del béisbol en Charros Sport Bar'],
                ['people2.webp', 'Grupo de amigos viendo partido de béisbol'],
                ['people3.webp', 'Clientes disfrutando comida y bebidas en Sport Bar'],
                ['people4.webp', 'Ambiente familiar en Charros Sport Bar Guadalajara'],
          ...
          <div
            ...
            <div class="text-center space-y-4">
              <h2 class="mb-6 text-4xl font-black text-gray-900 md:text-5xl">
                ¡Una experiencia <span class="text-blue-600">completa</span>!
              </h2>
              <h3
            ...
            <div class="grid grid-cols-1 gap-8 md:grid-cols-3 md:gap-10">
              <div class="group py-8 text-center hover:scale-105 transition-transform duration-300">
                <div
                  ...
                  <div
                    class="absolute inset-0 -m-4 rounded-2xl bg-gradient-to-br from-blue-400 to-blue-600 opacity-20 group-hover:opacity-30 transition-opacity blur-xl"></div>
                  <div
                    class="absolute inset-0 -m-3 rounded-2xl bg-gradient-to-br from-blue-500 to-blue-700 group-hover:scale-110 transition-transform"></div>
                  <span
                    class="relative text-2xl font-semibold text-white group-hover:scale-125 transition-transform">
                    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-hamburger"><path d="M12 16H4a2 2 0 1 1 0-4h16a2 2 0 1 1 0 4h-4.25"/><path d="M5 12a2 2 0 0 1-2-2 9 7 0 0 1 18 0 2 2 0 0 1-2 2"/><path d="M5 16a2 2 0 0 0-2 2 3 3 0 0 0 3 3h12a3 3 0 0 0 3-3 2 2 0 0 0-2-2q0 0 0 0"/><path d="m6.67 12 6.13 4.6a2 2 0 0 0 2.8-.4l3.15-4.2"/></svg>
                  </span>
                </div>
              ...
              <div class="group py-8 text-center hover:scale-105 transition-transform duration-300">
                <div
                  class="relative mb-8 mx-auto inline-flex h-20 w-20 items-center justify-center">
                  <div
                    class="absolute inset-0 -m-4 rounded-2xl bg-gradient-to-br from-purple-400 to-purple-600 opacity-20 group-hover:opacity-30 transition-opacity blur-xl"></div>
                  <div
                    class="absolute inset-0 -m-3 rounded-2xl bg-gradient-to-br from-purple-500 to-purple-700 group-hover:scale-110 transition-transform"></div>
                  <span
        ...
        <div class="relative bg-gray-50 overflow-hidden">
          <div class="absolute mt-14 mb-14 inset-0 skew-y-2 bg-gradient-to-br from-blue-900 via-blue-800 to-blue-900"></div>
          <div
            ...
            <div class="text-center space-y-4">
              <h2 class="text-4xl font-black text-white md:text-5xl drop-shadow-lg">
                ¿Cómo <span class="text-blue-300">reservar</span>?
              </h2>
              <p class="text-xl text-blue-100 max-w-2xl mx-auto">Sigue estos simples pasos y asegura tu lugar</p>
            </div>
            <!-- END Heading -->
            ...
            <div
              ...
              <div
                ...
                <svg height="56" viewBox="0 0 33.033 33.549" width="56" xmlns="http://www.w3.org/2000/svg"
                  class="hi-outline hi-cube mb-6 inline-block h-14 w-14 text-blue-300 group-hover:text-blue-200 transition-colors group-hover:scale-110 duration-300"
                  fill="currentColor">
                ...
                <div class="space-y-3">
                  <span class="inline-block px-3 py-1 bg-blue-500/30 rounded-full text-sm font-bold text-white">Paso 1</span>
              ...
              <div
                ...
                <div class="space-y-3">
                  <span class="inline-block px-3 py-1 bg-blue-500/30 rounded-full text-sm font-bold text-white">Paso 2</span>
                  <h4 class="text-xl font-bold text-white">
              ...
              <div
                ...
                <div class="space-y-3">
                  <span class="inline-block px-3 py-1 bg-blue-500/30 rounded-full text-sm font-bold text-white">Paso 3</span>
                  <h4 class="text-xl font-bold text-white">
            ...
            <div class="text-center pt-8">
              <a href="{{ route('reservation.show') }}" class="inline-block group">
                <button
                  type="button"
                  class="inline-flex items-center justify-center gap-3 rounded-full border-2 border-white bg-white px-10 py-5 leading-6 font-bold text-blue-900 hover:bg-blue-50 hover:scale-105 focus:ring-4 focus:ring-white/50 focus:outline-hidden transition-all duration-300 shadow-2xl text-lg">
        ...
        <div class="bg-gradient-to-b from-gray-50 to-white">
          <div
            ...
            <div class="text-center space-y-4">
              ...
              <h3
                class="mx-auto text-xl font-medium text-blue-700 md:leading-relaxed lg:w-3/4">
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:gap-10">
              ...
              <!-- Agency Plan -->
              <div
                class="relative group flex flex-col rounded-3xl border-2 border-blue-400 bg-gradient-to-br from-blue-600 to-blue-800 shadow-2xl hover:shadow-3xl hover:scale-105 transition-all duration-300">
                <div class="absolute inset-0 bg-gradient-to-tr from-blue-400/20 to-transparent rounded-3xl"></div>
                <div
                ...
                <div class="relative grow p-8 lg:p-10 space-y-6">
                  ...
                  <div class="space-y-2">
                    <span class="text-xs text-blue-100">Desde</span>
                    <div class="flex items-baseline gap-2">
                      <span class="text-5xl font-black text-white lg:text-6xl">$500</span>
                      <span class="text-lg font-semibold text-blue-100">por persona</span>
                    </div>
                ...
                <div class="relative rounded-b-3xl bg-white/10 backdrop-blur-sm p-6 lg:p-8 border-t border-white/20">
                  <a
                    href="{{ route('reservation.show') }}"
                    class="group inline-flex w-full items-center justify-center gap-2 rounded-full border-2 border-white bg-white px-8 py-4 leading-6 font-bold text-blue-900 hover:bg-blue-50 hover:scale-105 focus:ring-4 focus:ring-white/50 focus:outline-hidden transition-all duration-300 shadow-xl">
        ...
        <!-- Stats Section -->
        <div class="relative bg-gradient-to-br from-gray-900 via-blue-900 to-gray-900 overflow-hidden">
          ...
          <div class="relative container mx-auto px-4 py-20 lg:px-8 lg:py-32 xl:max-w-7xl">
            <div class="text-center mb-16 space-y-4">
              ...
              <p class="text-xl text-blue-200 max-w-2xl mx-auto">Forma parte de nuestra historia</p>
            </div>
            <div
              ...
              <div class="group relative">
                <div class="absolute inset-0 bg-gradient-to-br from-blue-400/20 to-blue-600/20 rounded-3xl blur-xl group-hover:blur-2xl transition-all duration-300"></div>
                <dl class="relative space-y-4 px-8 py-16 lg:py-20 bg-white/5 backdrop-blur-sm rounded-3xl border border-blue-400/30 hover:bg-white/10 hover:scale-105 transition-all duration-300">
                  <dt class="text-7xl font-black text-blue-400 drop-shadow-[0_0_15px_rgba(96,165,250,0.5)]">★★</dt>
                  <dd class="space-y-2">
                    <p class="text-2xl font-bold text-white">2 Campeonatos</p>
                    <p class="text-base font-semibold tracking-wide text-blue-300 uppercase">
            ...
            <div class="text-center mt-16">
              <p class="text-lg text-blue-200 max-w-3xl mx-auto leading-relaxed">
                Forma parte de la historia viviendo la emoción del béisbol profesional mexicano en <br> <span class="font-bold text-white">Charros Sport Bar</span>
              </p>
            </div>
          </div>
        </div>
