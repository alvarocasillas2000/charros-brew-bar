            ...
            <div class="bg-white overflow-hidden shadow-lg sm:rounded-2xl border border-gray-100">
                ...
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
                        <div class="bg-gradient-to-br from-gray-50 to-gray-50 border border-gray-200 rounded-xl p-5 shadow-sm hover:shadow-md transition-shadow">
                            <div class="flex items-center gap-3 mb-2">
                                ...
                                <div class="text-xs font-medium text-gray-600 uppercase tracking-wide">Día de Juego</div>
                            </div>
                        ...
                        <div class="bg-gradient-to-br from-gray-50 to-pink-50 border border-gray-200 rounded-xl p-5 shadow-sm hover:shadow-md transition-shadow">
                            <div class="flex items-center gap-3 mb-2">
                                <div class="w-10 h-10 rounded-lg bg-gray-600 flex items-center justify-center">
                                ...
                                <div class="text-xs font-medium text-gray-600 uppercase tracking-wide">Zona</div>
                            </div>
                    ...
                    <div class="bg-gradient-to-r from-gray-50 to-white rounded-xl border border-gray-200 p-6 mb-6">
                        <div class="flex items-center gap-3 mb-6">
                            <div class="w-10 h-10 rounded-lg bg-gradient-to-br from-gray-600 to-gray-800 flex items-center justify-center shadow-md">
                                        ...
                                        <tbody class="bg-white divide-y divide-gray-100">
                                            @foreach ($reservations as $reservation)
                                                <tr class="hover:bg-gradient-to-r hover:from-gray-50 hover:to-gray-50 transition-all duration-200 group">
                                                    <td class="px-4 py-3">
                                                        <span class="inline-flex items-center justify-center w-8 h-8 rounded-lg bg-gradient-to-br from-gray-600 to-gray-800 text-white text-xs font-bold shadow-sm">
                                                            {{ $reservation->id }}
                                                        </span>
                                                    </td>
                                                    <td class="px-4 py-3">
                                                    ...
                                                    <td class="px-4 py-3 text-right">
                                                        @if($reservation->transaction_id)
                                                            <a href="{{ route('reservation.details.with-notes', $reservation->transaction_id) }}" 
                                                               class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-gradient-to-r from-gray-600 to-gray-700 hover:from-gray-700 hover:to-gray-800 text-white rounded-lg text-xs font-medium shadow-sm hover:shadow-md hover:scale-105 transition-all duration-200">
