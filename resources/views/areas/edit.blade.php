                    ...
                    <form method="POST" action="{{ route('areas.update', $area->id) }}" class="space-y-6">
                        ...
                        <div class="relative">
                            ...
                            <div class="relative">
                                ...
                                <input type="number" 
                                       ...
                                       class="pl-8 w-full border-2 border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 transition-all duration-200 py-3 text-lg font-semibold"
                                       required>
                            </div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" 
                                   ...
                                   min="1"
                                   class="w-full border-2 border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 transition-all duration-200 py-3 text-lg font-semibold"
                                   required>
                            @error('max_capacity')
                                <p class="mt-1 text-sm text-red-600 flex items-center gap-1">
                                    <i class="fas fa-exclamation-circle"></i>
                        ...
                        <div class="bg-gradient-to-br from-blue-50 to-indigo-50 border-2 border-blue-200 rounded-xl p-6">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div class="bg-white rounded-lg p-3 border border-blue-100">
                                    ...
                                    <div class="text-2xl font-bold text-blue-600">{{ $area->actual_reserved_quantity ?? 0 }}</div>
                                </div>
                                <div class="bg-white rounded-lg p-3 border border-blue-100">
                        ...
                        <div class="flex flex-col sm:flex-row gap-3 pt-6 border-t border-gray-200">
                            <button type="submit" 
                                    class="flex-1 inline-flex items-center justify-center gap-2 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-bold py-3 px-6 rounded-lg shadow-lg hover:shadow-xl transition-all duration-200 hover:scale-[1.02]">
