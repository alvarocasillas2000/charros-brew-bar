...
<header id="page-header" class="flex flex-none items-center py-10  bg-gray-900">
    ...
    >
      <div>
        ...
        >
            <img src="./assets/img/LOGOblanco.png" alt="Charros de Jalisco" class="w-6 h-5" />
      ...
      >
        ...
        <a
          ...
          class="inline-flex items-center gap-2 font-semibold text-gray-400 hover:text-white"
        >
          <svg
