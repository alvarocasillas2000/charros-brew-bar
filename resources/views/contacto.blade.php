<x-app-layout>
    @php
        $seoTitle = 'Contacto | Charros Sport Bar';
        $seoDescription = 'Contáctanos para reservas, eventos especiales o cualquier duda sobre Charros Sport Bar. Estamos ubicados en el Estadio Charros de Jalisco. WhatsApp, correo y formulario de contacto disponibles.';
        $seoKeywords = 'contacto charros sport bar, telefono sport bar guadalajara, whatsapp reservas charros, eventos privados sport bar, ubicacion charros sport bar';
    ...
    <script type="application/ld+json">
    {
      ...
      "@type": "ContactPage",
      "name": "Contacto - Charros Sport Bar",
      "description": "Página de contacto para Charros Sport Bar",
      "url": "{{ route('contacto') }}",
      "mainEntity": {
        ...
        <main id="page-content" class="flex max-w-full flex-auto flex-col">
            ...
            <div class="bg-gradient-to-tr from-blue-900 via-blue-800 to-blue-900">
                <div class="container mx-auto px-4 pt-16 lg:px-8 lg:pt-32 xl:max-w-6xl text-center">
                    ...
                    <h3 class="mx-auto text-xl font-medium text-blue-100 md:text-2xl md:leading-relaxed lg:w-2/3 animate-slide-up-delay">
                    ...
                    <div class="flex flex-wrap justify-center gap-4 pt-10 pb-16">
                        <a href="#contacto-form" class="inline-flex items-center justify-center gap-3 rounded-full border-2 border-blue-600 bg-white px-8 py-4 font-bold text-blue-600 hover:bg-blue-50 hover:scale-105 transition-all duration-300 shadow-lg">
                        ...
                        <a href="https://wa.me/523312500826?text=%C2%A1Hola!%20Estuve%20viendo%20la%20p%C3%A1gina%20de%20Charros%20Sport%20Bar%20y%20tengo%20algunas%20dudas.%20%C2%BFMe%20podr%C3%ADan%20ayudar%3F" 
                    ...
                    <div class="relative mx-5 pb-12 -mb-20 rounded-2xl bg-white p-3 shadow-2xl sm:-mb-40 lg:mx-32 border-4 border-white/20 overflow-hidden">
                        <img src="{{ asset('assets/img/4E2A1479.jpeg') }}" alt="Interior de Charros Sport Bar con vista al estadio - Contacto y ubicación en Guadalajara" class="mx-auto w-full rounded-xl object-cover" />
                    </div>
                </div>
            </div>

                <!-- Formulario de contacto y Cards combinados -->
                <div class="bg-gradient-to-br from-gray-50 via-blue-50 to-purple-50 pt-40 pb-16">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
                            ...
                            <div>
                                <div class="mb-8" id="contacto-form">
                                    ...
                                    <p class="text-lg text-gray-600">
                                        Complete el formulario y <span class="font-bold text-blue-900">nuestro equipo te responderá pronto.</span>
                                    </p>
                                </div>
                                ...
                                <form action="{{ route('contacto.enviar') }}" method="POST" class="bg-white rounded-2xl p-8 shadow-xl border border-gray-100">
                                    ...
                                    <div class="mb-5">
                                        ...
                                        <input type="text" 
                                               ...
                                               class="w-full px-4 py-3 rounded-xl border-2 border-gray-200 focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500 transition-all duration-200" 
                                               required />
                                    </div>
                                    ...
                                    <div class="mb-5">
                                        ...
                                        <input type="email" 
                                               ...
                                               class="w-full px-4 py-3 rounded-xl border-2 border-gray-200 focus:ring-2 focus:ring-purple-500/50 focus:border-purple-500 transition-all duration-200" 
                                               required />
                                    </div>
                                    ...
                                    <div class="mb-6">
                                        ...
                                        <textarea id="mensaje" 
                                                  ...
                                                  class="w-full px-4 py-3 rounded-xl border-2 border-gray-200 focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500 transition-all duration-200 resize-none" 
                                                  required></textarea>
                                    </div>

                                    <button type="submit" class="w-full group inline-flex items-center justify-center gap-3 rounded-xl bg-gradient-to-r from-blue-600 to-blue-600 hover:from-blue-700 hover:to-blue-700 px-8 py-4 font-bold text-white hover:scale-[1.02] transition-all duration-300 shadow-lg hover:shadow-xl">
                            ...
                            <div>
                                <div class="mb-8 lg:pb-8">
                                    ...
                                    <p class="text-lg text-gray-600">
                                        Encuéntranos y <span class="font-bold text-blue-900">conéctate con nosotros.</span>
                                    </p>
                                </div>
                                ...
                                <div class="space-y-6">
                                    ...
                                    <div class="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 group cursor-pointer">
                                        <div class="flex items-start space-x-4">
                                            <div class="flex-shrink-0 w-14 h-14 bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl flex items-center justify-center shadow-md group-hover:scale-110 transition-transform">
                                    ...
                                    <div class="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 group cursor-pointer">
                                        <div class="flex items-start space-x-4">
                                            <div class="flex-shrink-0 w-14 h-14 bg-gradient-to-br from-purple-500 to-purple-600 rounded-xl flex items-center justify-center shadow-md group-hover:scale-110 transition-transform">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-7 h-7 text-white">
                                                    <path stroke-linecap="round" stroke-linejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />
                                                </svg>
                                            </div>
                                            <div class="flex-1">
                                                ...
                                                <a href="mailto:info@charrosjalisco.com" class="text-gray-600 hover:text-blue-600 transition-colors font-semibold break-all">
