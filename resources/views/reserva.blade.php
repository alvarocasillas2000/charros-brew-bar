                        ...
                        <form action="{{ route('reservation.store') }}" method="POST" id="reservation_form" class="max-w-4xl mx-auto mt-16 bg-gradient-to-br from-white to-gray-50 rounded-3xl shadow-2xl p-8 lg:p-12 border border-gray-100">
                            ...
                            <div class="space-y-8">
                                ...
                                <div id="availability-panel" class="hidden">
                                    <div class="bg-gradient-to-br from-gray-50 to-gray-50 border-2 border-gray-300 rounded-2xl p-6 shadow-xl">
                                        <div class="flex items-center gap-3 mb-4">
                                            <div class="w-10 h-10 rounded-full bg-gradient-to-br from-gray-600 to-gray-800 flex items-center justify-center shadow-lg">
