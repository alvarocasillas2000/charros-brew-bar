<x-app-layout>
    ...
    <div
        ...
        <main id="page-content" class="flex max-w-full flex-auto flex-col">
            <!-- Hero -->
            <div class="relative bg-gradient-to-tr from-gray-950 via-gray-900 to-gray-950 overflow-hidden">
                ...
                <div class="relative container mx-auto px-4 pt-20 lg:px-8 lg:pt-32 xl:max-w-6xl">
                    <div class="text-center space-y-6 animate-fade-in">
                        <h2 class="mb-4 text-4xl font-black text-balance text-white md:text-6xl drop-shadow-lg">
                            Reserva tu lugar en <span class="text-yellow-300">Charros Brew Bar</span>
                        </h2>
                    ...
                    <div class="flex flex-wrap justify-center gap-6 pt-12 pb-20">
                        <a href="#next-games" class="gold-button">
                ...
                <div class="bg-white pt-32 rounded-t-[3rem] -mt-12 relative z-10 shadow-2xl" id="reservation-form">
                    ...
                    <div class="flex justify-center px-4 -mt-20">
                        <div class="relative group">
                            <div class="absolute inset-0 bg-yellow-400/20 rounded-2xl blur-2xl group-hover:blur-3xl transition-all duration-300"></div>
                            <img
                    ...
                    <div class="text-center px-6 mt-4">
                        <p class="mt-4 text-xs text-gray-600">La imagen del mapa de Charros Brew Bar es con carácter ilustrativo y puede no representar con exactitud la distribución real del lugar. La reserva se lleva a cabo por área y no por mesa específica.</p>
                    </div>
                    <div class="container mx-auto px-4 py-20 lg:px-8 lg:py-32 xl:max-w-6xl">
                        <div class="text-center space-y-4" id="next-games">
                            <h2 class="mb-4 text-4xl font-black text-gray-900 md:text-5xl">
                                Próximos <span class="text-yellow-500">juegos</span>
                            </h2>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 pt-12">
                            ...
                            <div class="flex justify-center">
                                <div
                                    class="day-card group bg-white shadow-lg hover:shadow-2xl rounded-2xl p-8 w-full border-2 border-gray-100 hover:border-yellow-300 hover:bg-gradient-to-br hover:from-gray-50 hover:to-white transition-all duration-300 cursor-pointer transform hover:-translate-y-2 data-[selected=true]:bg-gradient-to-br data-[selected=true]:from-yellow-500 data-[selected=true]:to-yellow-700 data-[selected=true]:border-yellow-500 data-[selected=true]:shadow-2xl data-[selected=true]:scale-105"
                                    data-day-id="{{ $day->id }}">
                                    <div class="flex items-center gap-4 mb-4">
                                        <div class="w-14 h-14 rounded-full bg-gradient-to-br from-yellow-400 to-yellow-600 flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300 group-data-[selected=true]:bg-white group-data-[selected=true]:from-white group-data-[selected=true]:to-white">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-7 h-7 text-gray-900 group-data-[selected=true]:text-gray-900">
                        ...
                        <div class="text-center pt-20 space-y-4">
                            <h2 class="mb-4 text-4xl font-black text-gray-900 md:text-5xl">
                                Reserva tu <span class="text-yellow-500">lugar</span>
                            </h2>
                            <h3 class="mx-auto text-xl font-medium text-gray-700 md:leading-relaxed lg:w-2/3">
                        ...
                        <form action="{{ route('reservation.store') }}" method="POST" id="reservation_form" class="max-w-4xl mx-auto mt-16 bg-gradient-to-br from-white to-gray-50 rounded-3xl shadow-2xl p-8 lg:p-12 border border-gray-100">
                            ...
                            <div class="space-y-8">
                                    ...
                                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                                        ...
                                        <div class="sm:col-span-2">
                                            ...
                                            <div class="space-y-3 sm:space-y-0 sm:flex sm:items-center sm:gap-4">
                                                <input type="number" id="personas" min="{{ config('reservations.min_people_per_reservation') }}" value="{{ config('reservations.min_people_per_reservation') }}" name="personas" class="block w-full sm:flex-1 rounded-xl border-2 border-gray-200 px-4 py-3 shadow-sm focus:ring-2 focus:ring-gray-500 focus:border-gray-500 transition-all duration-200 text-base" required />
                                                <div class="flex items-center gap-3 sm:flex-shrink-0">
                                                    ...
                                                    <button type="button" id="showMapBtn" class="inline-flex items-center gap-1 px-3 py-1.5 bg-yellow-400 hover:bg-yellow-300 text-gray-900 text-xs font-semibold rounded-lg transition-all duration-200 shadow-md hover:shadow-lg hover:scale-105">
                                ...
                                <div id="availability-panel" class="hidden">
                                    <div class="bg-gradient-to-br from-gray-50 to-gray-50 border-2 border-yellow-200 rounded-2xl p-6 shadow-xl">
                                        <div class="flex items-center gap-3 mb-4">
                                            <div class="w-10 h-10 rounded-full bg-gradient-to-br from-yellow-400 to-yellow-600 flex items-center justify-center shadow-lg">
                                            ...
                                            <h3 class="text-xl font-black text-gray-900">Detalles de tu Reserva</h3>
                                        </div>
                                ...
                                <div class="bg-gray-50 rounded-2xl p-6 border-2 border-yellow-200">
                                    <div class="flex items-start gap-3">
                                        ...
                                        <label for="terminos" class="text-sm text-gray-700 leading-relaxed cursor-pointer">
                                            Acepto los <a href="{{ route('terminos') }}" target="_blank" class="text-yellow-600 font-bold underline hover:text-yellow-700">términos y condiciones</a> del servicio de reservas de Charros Brew Bar.
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="text-center pt-6">
                                    <button type="submit" class="gold-button text-lg shadow-yellow-400/30">
                ...
                <div id="mapModal" class="hidden fixed inset-0 z-50 overflow-y-auto">
                    <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
                        ...
                        <div class="inline-block align-bottom bg-white rounded-3xl text-left overflow-hidden shadow-2xl transform transition-all sm:my-8 sm:align-middle sm:max-w-4xl sm:w-full">
                            <div class="bg-gradient-to-r from-yellow-500 to-yellow-700 px-6 py-4 flex items-center justify-between">
                            ...
                            <div class="bg-white px-6 py-6">
                                ...
                                <div class="mt-6 bg-gray-50 rounded-xl p-4 border-2 border-gray-200">
                                    <p class="text-sm text-gray-900 leading-relaxed">
                                        Este mapa muestra la distribución de las áreas disponibles en Charros Brew Bar. Selecciona tu área preferida en el formulario de reserva.
                                    </p>
                            ...
                            <div class="bg-gray-50 px-6 py-4 flex justify-end">
                                <button type="button" id="closeMapModalBtn" class="inline-flex items-center gap-2 px-6 py-3 bg-yellow-400 hover:bg-yellow-300 text-gray-900 font-semibold rounded-xl transition-all duration-200 shadow-md hover:shadow-lg">
                                    Cerrar
                                </button>
                            </div>
                        </div>
                            ...
                            <div class="bg-white px-6 py-6">
                                ...
                                <div id="emailConfirmContent" class="space-y-4">
                                    ...
                                    <div class="bg-gray-50 rounded-xl p-4 border-2 border-gray-200">
                                        <p class="text-sm text-gray-700 font-medium mb-2">Correo electrónico:</p>
                                        <p id="confirmEmailValue" class="text-xl font-bold text-gray-900 break-all"></p>
                                    </div>
                                ...
                                <div id="emailConfirmLoading" class="hidden space-y-6">
                                    <div class="flex flex-col items-center justify-center py-8">
                                        <div class="relative">
                                            <div class="w-20 h-20 border-8 border-gray-200 border-t-gray-600 rounded-full animate-spin"></div>
                                            <div class="absolute inset-0 flex items-center justify-center">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-8 h-8 text-gray-600 animate-pulse">
                                                    <path d="M3 4a2 2 0 0 0-2 2v1.161l8.441 4.221a1.25 1.25 0 0 0 1.118 0L19 7.162V6a2 2 0 0 0-2-2H3Z" />
                                                    <path d="m19 8.839-7.77 3.885a2.75 2.75 0 0 1-2.46 0L1 8.839V14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V8.839Z" />
                                                </svg>
                                            </div>
                ...
                <div id="specialEventModal" class="hidden fixed inset-0 z-50 overflow-y-auto">
                    <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
                        ...
                        <div class="inline-block align-bottom bg-white rounded-3xl text-left overflow-hidden shadow-2xl transform transition-all sm:my-8 sm:align-middle sm:max-w-2xl sm:w-full">
                            <div class="bg-gradient-to-r from-gray-600 to-gray-700 px-6 py-4 flex items-center justify-between">
                                <h3 class="text-2xl font-bold text-white flex items-center gap-3">
                                ...
                                <div class="space-y-5">
                                    ...
                                    <div class="flex items-start gap-4">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <p class="text-base text-gray-700">Has seleccionado el área: <span id="specialEventAreaName" class="font-bold text-gray-700"></span></p>
                                        </div>
                                    </div>
                            ...
                            <div class="bg-gray-50 px-6 py-4 flex flex-col sm:flex-row gap-3 justify-end">
                                ...
                                <button type="button" id="acceptSpecialEventBtn" class="inline-flex items-center justify-center gap-2 px-6 py-3 bg-gradient-to-r from-gray-600 to-gray-700 hover:from-gray-700 hover:to-gray-800 text-white font-bold rounded-xl transition-all duration-200 shadow-md hover:shadow-lg">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5">
                                        <path fill-rule="evenodd" d="M16.704 4.153a.75.75 0 0 1 .143 1.052l-8 10.5a.75.75 0 0 1-1.127.075l-4.5-4.5a.75.75 0 0 1 1.06-1.06l3.894 3.893 7.48-9.817a.75.75 0 0 1 1.05-.143Z" clip-rule="evenodd" />
                                    </svg>
                                    Entiendo, Continuar
